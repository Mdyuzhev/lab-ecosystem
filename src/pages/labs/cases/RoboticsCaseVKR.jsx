...
import {
  ArrowRight, CheckCircle, Clock, Calculator,
  RefreshCw, Table, GitBranch, LayoutGrid, Lightbulb
} from 'lucide-react'

export default function RoboticsCaseVKR() {
  return (
    <div className="min-h-screen bg-slate-950">
      ...
      <section className="relative py-20 overflow-hidden">
        ...
        <div className="relative max-w-6xl mx-auto px-6">
          ...
          <div className="flex items-center gap-2 text-sm text-slate-400 mb-6">
            <Link to="/labs/robotics" className="hover:text-white transition-colors">Лаборатория Робототехники</Link>
            <span>/</span>
      ...
      {/* Решение: три детерминированных инструмента */}
      <section className="py-16">
        <div className="max-w-6xl mx-auto px-6">
